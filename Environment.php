...
use ThinkHaml\Target\Php;
use ThinkHaml\Target\Twig;
use ThinkHaml\NodeVisitor\Escaping as EscapingVisitor;
use ThinkHaml\NodeVisitor\Autoclose;
use ThinkHaml\NodeVisitor\Midblock;
use ThinkHaml\NodeVisitor\MergeAttrs;
use ThinkHaml\Filter\FilterInterface;
...
class Environment
{
    protected $options = array(
        ...
        'escape_attrs' => true,
        'cdata' => true,
        'autoclose' => array('meta', 'img', 'link', 'br', 'hr', 'input', 'area', 'param', 'col', 'base', 'include'),
        'charset' => 'UTF-8',
    );

    protected $filters = array(
        'css' => 'ThinkHaml\\Filter\\Css',
        'cdata' => 'ThinkHaml\\Filter\\Cdata',
        'escaped' => 'ThinkHaml\\Filter\\Escaped',
        'javascript' => 'ThinkHaml\\Filter\\Javascript',
        'php' => 'ThinkHaml\\Filter\\Php',
        'plain' => 'ThinkHaml\\Filter\\Plain',
        'preserve' => 'ThinkHaml\\Filter\\Preserve',
        'twig' => 'ThinkHaml\\Filter\\Twig',
    );
