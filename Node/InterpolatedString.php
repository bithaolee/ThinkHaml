...
class InterpolatedString extends NodeAbstract
{
    ...
    public function addChild(NodeAbstract $child)
    {
        ...
        if (!$child instanceof Text && !$child instanceof Insert) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s() must be an instance of ThinkHaml\Node\Text or ThinkHaml\Node\Insert, instance of %s given', __METHOD__, get_class($child)));
        }
